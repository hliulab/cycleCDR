...
adata_cpa = sc.read('./datasets/preprocess/dixit/pre_perturb_processed.h5ad')
...
for set_name in set_names:
    ...
    for cell_id in cell_ids:
        ...
        treat_df.to_csv(
            f"./datasets/preprocess/dixit/treat_{set_name}_{cell_id}.csv",
            index=False,
        )
        control_df.to_csv(
            f"./datasets/preprocess/dixit/control_{set_name}_{cell_id}.csv",
            index=False,
        )
