...
print("rpe1 all gene r2 mean: ", mean(rpe1_all_gene_r2_list))
print("rpe1 all gene r2 median: ", median(rpe1_all_gene_r2_list))
print("rpe1 deg gene r2 mean: ", mean(rpe1_de_gene_r2_list))
print("rpe1 deg gene r2 median: ", median(rpe1_de_gene_r2_list))
