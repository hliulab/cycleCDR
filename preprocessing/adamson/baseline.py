...
control = pd.read_csv("./datasets/preprocess/adamson/control_test.csv")
# adata_cpa = sc.read(
...
treat = pd.read_csv("./datasets/preprocess/adamson/treat_test.csv")

de_gene_idx = pd.read_csv("./datasets/preprocess/adamson/deg_gene.csv")
