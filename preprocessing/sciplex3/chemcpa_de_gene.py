...
adata = sc.read('./datasets/preprocess/sciplex3/sciplex3_filtered_genes_for_split.h5ad')
...
deg_gene.to_csv("./datasets/preprocess/sciplex3/chemcpa_deg_gene.csv")
...
pickle.dump(
    idx.tolist()[:200],
    open("./datasets/preprocess/sciplex3/chemcpa_mse_hvg_idx.pkl", "wb"),
)
