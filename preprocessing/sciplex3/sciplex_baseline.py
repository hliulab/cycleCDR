...
treat = pd.read_csv("./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_test.csv")

de_gene_idx = pd.read_csv("./datasets/preprocess/sciplex3/chemcpa_deg_gene.csv")
...
for cov_drug, treat_df in treat.groupby("cov_drug"):
    ...
    de_gene_r2_list.append(de_gene_r2)
