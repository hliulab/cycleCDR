...
treat_train_MCF7_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_train_MCF7.csv"
)
treat_train_K562_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_train_K562.csv"
)
treat_train_A549_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_train_A549.csv"
)
...
treat_train_df.to_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_train.csv", index=False
)
print(treat_train_df.shape)

control_train_MCF7_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_train_MCF7.csv"
)
control_train_K562_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_train_K562.csv"
)
control_train_A549_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_train_A549.csv"
)
...
control_train_df.to_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_train.csv", index=False
)
...
treat_valid_MCF7_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_valid_MCF7.csv"
)
treat_valid_K562_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_valid_K562.csv"
)
treat_valid_A549_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_valid_A549.csv"
)
...
treat_valid_df.to_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_valid.csv", index=False
)
print(treat_valid_df.shape)

control_valid_MCF7_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_valid_MCF7.csv"
)
control_valid_K562_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_valid_K562.csv"
)
control_valid_A549_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_valid_A549.csv"
)
...
control_valid_df.to_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_valid.csv", index=False
)
...
treat_test_MCF7_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_test_MCF7.csv"
)
treat_test_K562_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_test_K562.csv"
)
treat_test_A549_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_test_A549.csv"
)
...
treat_test_df.to_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_test.csv", index=False
)
print(treat_test_df.shape)

control_test_MCF7_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_test_MCF7.csv"
)
control_test_K562_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_test_K562.csv"
)
control_test_A549_df = pd.read_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_test_A549.csv"
)
...
control_test_df.to_csv(
    "./datasets/preprocess/sciplex3/chemcpa_trapnell_control_test.csv", index=False
)
