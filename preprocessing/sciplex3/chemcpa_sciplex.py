...
for set_name in set_names:
    ...
    for cell_id in cell_ids:
        ...
        treat_df.to_csv(
            f"./datasets/preprocess/sciplex3/chemcpa_trapnell_treat_{set_name}_{cell_id}.csv",
            index=False,
        )
        control_df.to_csv(
            f"./datasets/preprocess/sciplex3/chemcpa_trapnell_control_{set_name}_{cell_id}.csv",
            index=False,
        )
