...
de_gene_idx = pd.read_csv("./datasets/preprocess/replogle_k562_essential/deg_gene.csv")
...
k562_all_gene_r2_list = []
k562_de_gene_r2_list = []
k562_all_gene_explained_variance_list = []
k562_de_gene_explained_variance_list = []
...
for cov_drug, treat_df in treat.groupby("cov_pert"):
    ...
    if cov_drug.split("_")[0] == "K562":
        ...
        k562_all_gene_r2_list.append(r2)
        k562_all_gene_explained_variance_list.append(explained_variance)
    else:
    ...
    if cov_drug.split("_")[0] == "K562":
        ...
        k562_de_gene_r2_list.append(de_r2)
        k562_de_gene_explained_variance_list.append(de_explained_variance)
    else:
        raise ValueError("cell type error: ", cov_drug.split("_")[0])
...
print("K562 all gene r2 mean: ", mean(k562_all_gene_r2_list))
print("K562 all gene r2 median: ", median(k562_all_gene_r2_list))
print("K562 deg gene r2 mean: ", mean(k562_de_gene_r2_list))
print("K562 deg gene r2 median: ", median(k562_de_gene_r2_list))
print(
    "K562 all gene explained variance mean: ",
    mean(k562_all_gene_explained_variance_list),
)
print(
    "K562 all gene explained variance median: ",
    median(k562_all_gene_explained_variance_list),
)
print(
    "K562 deg gene explained variance mean: ",
    mean(k562_de_gene_explained_variance_list),
)
print(
    "K562 deg gene explained variance median: ",
    median(k562_de_gene_explained_variance_list),
)
