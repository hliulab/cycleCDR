...
adata_cpa = sc.read("./datasets/preprocess/sciplex4/sciplex4_filtered_genes.h5ad")
...
adata_cpa.write("./datasets/preprocess/sciplex4/sciplex4_filtered_genes_for_smiles.h5ad")
