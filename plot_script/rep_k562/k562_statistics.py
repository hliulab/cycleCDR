...
train_data = pd.read_csv("./datasets/preprocess/replogle_k562_essential/treat_train.csv")
...
valid_data = pd.read_csv("./datasets/preprocess/replogle_k562_essential/treat_valid.csv")
...
test_data = pd.read_csv("./datasets/preprocess/replogle_k562_essential/treat_test.csv")
