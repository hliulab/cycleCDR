...
treat_train_data = pd.read_csv(
    "./datasets/preprocess/sciplex4/chemcpa_trapnell_treat_train.csv"
)
...
treat_valid_data = pd.read_csv(
    "./datasets/preprocess/sciplex4/chemcpa_trapnell_treat_valid.csv"
)
...
treat_test_data = pd.read_csv(
    "./datasets/preprocess/sciplex4/chemcpa_trapnell_treat_test.csv"
)
...
control_train_data = pd.read_csv(
    "./datasets/preprocess/sciplex4/chemcpa_trapnell_control_train.csv"
)
...
control_valid_data = pd.read_csv(
    "./datasets/preprocess/sciplex4/chemcpa_trapnell_control_valid.csv"
)
...
control_test_data = pd.read_csv(
    "./datasets/preprocess/sciplex4/chemcpa_trapnell_control_test.csv"
)
